...
async function home(filter) {
  ...
  let filterObj = {
   ...
   小可音乐:[{key:'tid',name:'分类','value':[{n:'全部',v:'小可音乐'},{n:'DJ小可',v:'DJ小可'},{n:'冰河时代DJ',v:'冰河时代DJ'},{n:'韩国dj舞曲',v:'韩国dj舞曲'},{n:'凤舞九天dj',v:'凤舞九天dj'},{n:'dj晓贝',v:'dj晓贝音乐'},{n:'DJ嗨曲',v:'DJ嗨曲'},{n:'DJ何鹏',v:'DJ何鹏'},{n:'DJ劲爆',v:'DJ劲爆'},{n:'DJ串烧',v:'DJ串烧'}]}],
